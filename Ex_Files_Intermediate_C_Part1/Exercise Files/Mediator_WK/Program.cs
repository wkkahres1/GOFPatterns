...
namespace Mediator_WK
{
    ...
    {
        public abstract void Register(Participant participant); //take in participant
        public abstract void Send(   //sends message
    ...
    class Chatroom : AbstractChatroom
    {
        private Dictionary<string, Participant> _participants =
          new Dictionary<string, Participant>(); //holds string and participant
