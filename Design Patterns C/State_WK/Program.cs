...
namespace State_WK
{
    ...
    class client
    {
        ...
        {
            // Open a new account
            Account account = new Account("Walter Kahres");

            //Apply transactions
            account.Deposit(490.0);
            account.Deposit(390.0); //   880
            account.Deposit(540.0); //  1420
            account.PayInterest();  //  1491
            account.Withdraw(2200); // (709)
            account.Withdraw(1300); // negative balance
        }
    }
