...
namespace Facade_WK
{
    ...
    class Client
    {
        ...
        static void Main()
        {
            ...
            //Evaluate eligibility for the Student
            Student student = new Student("Walter Kahres");
            bool eligible = collegeLoan.IsEligible(student, 75000);

            //Write to Console results (works like excel if eligible true, approved, else rejected)
